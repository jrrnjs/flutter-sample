...
class FlickrApi {
  static Future<http.Response> getImages(String searchText, int page) {
    var url = baseUrl + '/services/rest/?method=flickr.photos.search&api_key=${apiKey}&text=${searchText}&safe_search=1&content_type=1&sort=interestingness-desc&per_page=30&format=json&page=${page}';
